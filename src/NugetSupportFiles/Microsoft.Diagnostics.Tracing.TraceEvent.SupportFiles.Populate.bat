...
xcopy /s %HOMEDRIVE%%HOMEPATH%\.nuget\packages\Microsoft.Diagnostics.Tracing.TraceEvent.SupportFiles\1.0.7\*.dll Microsoft.Diagnostics.Tracing.TraceEvent.SupportFiles
