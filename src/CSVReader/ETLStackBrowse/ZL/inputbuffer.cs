namespace System.IO.Compression2
{
    ...
    internal class InputBuffer
    {
        ...
        public void SetInput(byte[] inputBuffer, int offset, int length)
        {
            Debug.Assert(inputBuffer != null, "");
            Debug.Assert(offset >= 0, "");
            Debug.Assert(length >= 0, "");
            Debug.Assert(offset <= inputBuffer.Length - length, "");
