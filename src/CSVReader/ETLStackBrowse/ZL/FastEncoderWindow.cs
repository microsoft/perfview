namespace System.IO.Compression2
{
    ...
    internal class FastEncoderWindow
    {
        ...
        // Hashtable structure
        private ushort[] prev;     // next most recent occurrence of chars with same hash value
        private ushort[] lookup;   // hash table to find most recent occurrence of chars with same hash value
        ...
        /// </summary>
        public int FreeWindowSpace => 2 * FastEncoderWindowSize - bufEnd;
        ...
        public void MoveWindows()
        {
            ...
            {
                int val = lookup[i] - FastEncoderWindowSize;
        ...
        {
            // Note we only use the lowest 11 bits of the hash value (hash table size is 11).
        ...
        private void VerifyHashes()
        {
            for (int i = 0; i < FastEncoderHashtableSize; i++)
            {
                ...
                while (where != 0 && bufPos - where < FastEncoderWindowSize)
                {
                    ...
                    ushort nextWhere = prev[where & FastEncoderWindowMask];
