    ...
    internal static class ZipHelper
    {
        ...
        internal static void ReadBytes(Stream stream, Byte[] buffer, Int32 bytesToRead)
        {
            ...
            while (bytesLeftToRead > 0)
            {
                ...
                if (bytesRead == 0) throw new IOException(System.IO.Compression.Messages.UnexpectedEndOfStream);
        ...
        */
        ...
        internal static UInt32 DateTimeToDosTime(DateTime dateTime)
        {
            ...
            Contract.Assert(ValidZipDate_YearMin <= dateTime.Year && dateTime.Year <= ValidZipDate_YearMax);
