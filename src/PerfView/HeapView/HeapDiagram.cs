...
namespace PerfView
{
    ...
    {
        StreamGeometry        m_geometry;
        StreamGeometryContext m_context;
    ...
    class Renderer
    {
        const double minWidth = 0.1;   // min GC bar width
        ...
        ColorScheme m_g0Palette;
        ColorScheme m_g1Palette;
        ColorScheme m_g2Palette;
        ColorScheme m_gLPalette;
        ColorScheme m_gTPalette;

        ColorScheme[] m_Palettes;
        ...
        double MapXDelta(double t)
        {
            return t * m_x1;
        }
        
        void DrawRect(Brush b, double x, double y, double width, double height)
        {
            if ((width > 0) && (height > 0))
            {
        ...
        void DrawText(double x, double y, string text, double size = 9)
        {
        ...
        static double Diff(Point p0, Point p1)
        {
    ...
    /// Diagram generation
    /// </summary>
    class HeapDiagramGenerator
    {
        static double CheckMax(ref double max, double value)
        {
            if (value > max)
            {
                max = value;
        ...
        void SetYScale(Renderer render)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        // GC event marks + 
        // Heap size curves
        void DrawGCEvents(Renderer render)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void DrawThreads(Renderer render)
        {
    ...
    public class HeapDiagram
    {
        ...
        DockPanel m_topPanel;
        DockPanel m_leftPanel;

        CheckBox m_timeline;
        CheckBox m_drawMarker;

        ScrollViewer m_scrollViewer;
        Label m_zoomLabel, m_posLabel;
        VisualHolder m_diagramHolder;
        Slider m_zoomSlider;
  //    Button m_testButton;
        ...
        int m_graphWidth = 80 * 11;
        int m_graphHeight = 80 * 5;
        double m_widthZoom = 1;

        RubberBandAdorner m_rubberBand;
        ...
        void ZoomValueChanged(object sender, RoutedPropertyChangedEventArgs<double> value)
        {
            SetZoom(value.NewValue);
        }

        void ToggleTimeline(object sender, RoutedEventArgs e)
        {
            RedrawDiagram();
        ...
        void ToggleDrawMarker(object sender, RoutedEventArgs e)
        {
            RedrawDiagram();
        }

        int FindEvent(double tick, int start)
        {
        ...
        ToolTip m_tip;
        DataGrid m_metricGrid;
        StackPanel m_leftLegend;
        ...
        /// Zoom to time range
        /// </summary>
        void OnZoomTo(object sender, RoutedEventArgs e)
        {
        ...
        StackWindowHook m_cpuStack;
        StackWindowHook m_allocStack;
        StackWindowHook m_vmallocStack;

        /// <summary>
        /// Create/update ContextMenu for RubbeerBand adorner
        /// </summary>
        bool CreateContextMenu(ContextMenu cm, Point start, Point end)
        {
        ...
        Stack<DiagramPara> m_cropList = new Stack<DiagramPara>();

        /// <summary>
        /// Crop diagram to displayed time range, for performance, bigger zoom range
        /// </summary>
        void OnCropDiagram(object sender, RoutedEventArgs e)
        {
        ...
        /// Undo Crop
        /// </summary>
        void OnUndoCrop(object sender, RoutedEventArgs e)
        {
