...
namespace PerfView
{
    ...
    public class VisualHolder : FrameworkElement
    {
        ...
        public void SetZoom(double zoom)
        {
            ...
            this.Width  = m_width * m_displayZoom;
            this.Height = m_height;

            this.RenderTransform = new ScaleTransform(m_displayZoom, 1, 0, 0);
        }
    ...
    class HtmlWriter : StreamWriter
    {
        ...
        {
            this.WriteLine("<table cellspacing=\"0\" border=\"1\">");
        }
    }
    ...
    static class Toolbox
    {
        ...
        /// </summary>
        static object FindChild(Visual visual, Type typ)
        {
            if (visual == null)
                return null;
        ...
        /// </summary>
        static void WalkTree(StringBuilder sb, Visual visual)
        {
            if (visual == null)
                return;
        ...
        /// </summary>
        static internal Style RightJustifyStyle(Style baseStyle)
        {
            Style s = new Style();
        ...
        /// </summary>
        static internal DataGridTemplateColumn AddButtonColumn(this DataGrid grid, Type dataType, object header, string binding, RoutedEventHandler OnClick = null)
        {
        ...
        /// </summary>
        static internal DataGridTextColumn AddColumn(this DataGrid grid, object header, string binding, bool right = false, string format = null)
        {
        ...
        /// Add column to Datagrid
        /// </summary>
        static internal DataGridTextColumn AddColumn(this DataGrid grid, object header, string binding, IValueConverter converter, object para = null, bool right = false)
        {
            DataGridTextColumn col = new DataGridTextColumn();
        ...
        /// Create CheckBox
        /// </summary>
        static internal CheckBox CreateCheckBox(bool state, string label, int left = 0, int top = 0, RoutedEventHandler checkHandler = null)
        {
        ...
        /// Add CheckBox
        /// </summary>
        static internal CheckBox AddCheckBox(this Panel panel, bool state, string label, int left = 0, int top = 0, RoutedEventHandler checkHandler = null)
        {
        ...
        /// Create Button
        /// </summary>
        static internal Button CreateButton(string label, int width, RoutedEventHandler onClick, int left = 0, int top = 0)
        {
        ...
        /// Add Button
        /// </summary>
        static internal Button AddButton(this Panel panel, string label, int width, RoutedEventHandler onClick, int left = 0, int top = 0)
        {
        ...
        /// </summary>
        static internal TextBlock CreateTextBlock(string label, string param, RoutedEventHandler binding, int left = 0, int top = 0)
        {
        ...
        /// </summary>
        static internal TextBlock AddTextBlock(this Panel panel, string label, string param, RoutedEventHandler binding, int left = 0, int top = 0)
        {
        ...
        /// </summary>
        static internal bool UnChecked(this ToggleButton button)
        {
        ...
        /// Add MenuItem
        /// </summary>
        static internal MenuItem AddItem(this ItemsControl menu, string header, bool checkable = false, bool chked = false)
        {
        ...
        /// </summary>
        static internal void HookupVisibility(this MenuItem item, UIElement target)
        {
        ...
        /// Collapse UIElement
        /// </summary>
        static internal void MakeCollapsed(object sender, RoutedEventArgs e)
        {
        ...
        /// </summary>
        static internal void MakeVisible(object sender, RoutedEventArgs e)
        {
            MenuItem item = sender as MenuItem;
        ...
        /// </summary>
        static internal void SelectClrProcess(this TraceLog traceLog, Action<List<IProcess>> action)
        {
            bool hasClr = false;
        ...
        /// </summary>
        static internal string SaveAsPng(Visual visual, int width, int height, string fileName)
        {
        ...
        /// </summary>
        static internal string SaveAsXps(Visual visual, int width, int height, string fileName)
        {
        ...
        /// </summary>
        static internal Panel Wrap(this Panel panel, string help)
        {
        ...
        /// </summary>
        static internal string GetSaveFileName(string fileName, string ext, string description)
        {
        ...
        /// </summary>
        static internal string GetMethodName(this TraceLog log, CodeAddressIndex index)
        {
        ...
        /// </summary>
        static internal StackSource CreateStackSource(this PerfViewFile dataFile, string stream, int procID, TextWriter log, bool largeAlloc = false)
        {
        ...
        /// </summary>
        static internal void StackWindowTo(this PerfViewFile dataFile, Window parent, ref StackWindow stackWindow, StackSource source, string stream, double t0 = 0, double t1 = 0)
        {
            if (stackWindow == null)
            {
                if (source != null)
    ...
    class RubberBandAdorner : Adorner
    {
        Point             m_startPoint;
        Point             m_endPoint;
        FrameworkElement  m_canvas;
        AdornerLayer      m_layer;
        bool              m_bandVisible;
        bool              m_selectionGood;
        AddExtra          m_addExtra;
        CreateContextMenu m_createMenu;
        ...
        void OnMouseRightButtonUp(object sender, RoutedEventArgs e)
        {
            if (m_selectionGood)
            {
    ...
    class StackWindowHook
    {
        ...
        void OnCloseStack(object sender, EventArgs e)
        {
            m_stackWindow = null;
        }
        ...
        void OnStackTo(object sender, RoutedEventArgs e)
        {
    ...
    class ColorScheme
    {
        ...
        static Pen CreateRoundPen(Brush brush, double thickness)
        {
        ...
        static public Color ToRgbColor(int hue, int saturation, int luminosity)
        {
    ...
    {
        TraceLog                                          m_trace;
        TraceCodeAddresses                                m_addresses;
        TraceModuleFiles                                  m_modules;
        TraceCallStacks                                   m_stacks;
        ModuleClass[]                                     m_modList;
        ...
        ModuleClass GetClass(TraceModuleFile mod)
        {
