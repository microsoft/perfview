...
namespace Stats
{
    internal static class GcStats
    {
        ...
        private static string[][] CondemnedReasonsHtmlHeader = new string[(int)CondemnedReasonGroup.Max][]
        {
            ...
            new string[] {"Ephemeral Low<BR/>with Very<BR/>Fragmented Gen2", "We are running low on the ephemeral segment but gen2 is fragmented enough to compensate that, doing a full GC"},
