...
namespace Stats
{
    internal static class GcStats
    {
        ...
        private static string[][] CondemnedReasonsHtmlHeader = new string[(int)CondemnedReasonGroup.Max][]
        {
            ...
            new string[] {"Compacting full<BR>under hard limit", "Last GC we trigger before we throw OOM under hard limit"},
            new string[] {"LOH frag<BR> hard limit", "This happens when we had a heap limit and the LOH fragmentation is > 1/8 of the hard limit"},
            new string[] {"LOH reclaim<BR>hard limit", "This happens when we had a heap limit and we could potentially reclaim from LOH is > 1/8 of the hard limit"},
