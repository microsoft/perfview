...
namespace PerfView
{
    class OverWeigthReport
    {
        ...
        static void ComputeOverweights(
            ...
            double total2)
        {
            ...
            {
                if (r1.interest < r2.interest) return 1;
                if (r1.interest > r2.interest) return -1;
                if (r1.overweight < r2.overweight) return 1;
                if (r1.overweight > r2.overweight) return -1;
                if (r1.delta < r2.delta) return -1;
                if (r1.delta > r2.delta) return 1;
                return 0;
            });
        }

        static double LoadOneTrace(StackSource source, Dictionary<string, double> dict)
        {
