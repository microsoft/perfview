...
namespace Microsoft.Samples.Debugging.CorDebug.NativeApi
{
    ...
    public struct COR_ARRAY_LAYOUT
    {
        ...
        public CorComponentType componentType;     // Whether the component itself is a GC reference, value class, or primitive
    ...
    public struct COR_FIELD
    {
        ...
        public CorComponentType fieldType;
    };
...
#else
        void DebugEvent(DEBUG_EVENT debugEvent, [In] int fOutOfBand);
#endif
    }
...
#if !MDBG_SAMPLE
    [ComImport, InterfaceType(1), Guid("A1B8A756-3CB6-4CCB-979F-3DF999673A59")]
    public interface ICorDebugMutableDataTarget : ICorDebugDataTarget
    {
        #region ICorDebugDataTarget members
        new CorDebugPlatform GetPlatform();

        new uint ReadVirtual(System.UInt64 address,
                         IntPtr buffer,
                         uint bytesRequested);

        new void GetThreadContext(uint threadId,
                                 uint contextFlags,
                                 uint contextSize,
                                 IntPtr context);
        #endregion

        void WriteVirtual(System.UInt64 address,
                             IntPtr buffer,
                             uint bytesRequested);
        ...
        void ContinueStatusChanged(uint dwThreadId,
