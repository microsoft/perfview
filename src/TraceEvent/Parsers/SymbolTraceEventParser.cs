...
namespace Microsoft.Diagnostics.Tracing.Parsers
{
    ...
    public sealed class SymbolTraceEventParser : TraceEventParser
    {
        ...
        public event Action<WinSatConfigTraceData> WinSatSystemConfig
        {
            add
            {
                // action, eventid, taskid, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName
                source.RegisterEventTemplate(new WinSatConfigTraceData(value, 0xFFFF, 0, "WinSat", WinSatTaskGuid, 37, "SystemConfig", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        protected internal override void EnumerateTemplates(Func<string, string, EventFilterResponse> eventsToObserve, Action<TraceEvent> callback)
        {
            if (s_templates == null)
            {
                ...
                templates[5] = new EmptyTraceData(null, 0xFFFF, 0, "WinSat", WinSatTaskGuid, 33, "WinSPR", ProviderGuid, ProviderName);
                templates[6] = new EmptyTraceData(null, 0xFFFF, 0, "WinSat", WinSatTaskGuid, 35, "Metrics", ProviderGuid, ProviderName);
                templates[7] = new WinSatConfigTraceData(null, 0xFFFF, 0, "WinSat", WinSatTaskGuid, 37, "SystemConfig", ProviderGuid, ProviderName);
        ...
        internal static Guid PerfTrackMetaDataTaskGuid = new Guid(unchecked((int)0xbf6ef1cb), unchecked((short)0x89b5), 0x490, 0x80, 0xac, 0xb1, 0x80, 0xcf, 0xbc, 0xff, 0x0f);
        internal static Guid ImageIdTaskGuid = new Guid(unchecked((int)0xb3e675d7), 0x2554, 0x4f18, 0x83, 0x0b, 0x27, 0x62, 0x73, 0x25, 0x60, 0xde);
        #endregion
    }
}
...
namespace Microsoft.Diagnostics.Tracing.Parsers.Symbol
{
    ...
    public sealed class WinSatConfigTraceData : TraceEvent
    {
        /// <summary>
        ...
        /// </summary>
        public WinSatConfigTraceData(Action<WinSatConfigTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<WinSatConfigTraceData> Action;
        /// <summary>
        /// implementation of TraceEvent Interface. 
        /// </summary>
        protected internal override void Dispatch()
        ...
        {
            get { return Action; }
            set { Action = (Action<WinSatConfigTraceData>)value; }
        }
