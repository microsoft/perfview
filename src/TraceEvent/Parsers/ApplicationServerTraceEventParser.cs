...
namespace Microsoft.Diagnostics.Tracing.Parsers
{
    ...
    {
        public static string ProviderName = "Microsoft-Windows-Application Server-Applications";
        public static Guid ProviderGuid = new Guid(unchecked((int)0xc651f5f6), unchecked((short)0x1c0d), unchecked((short)0x492e), 0x8a, 0xe1, 0xb4, 0xef, 0xd7, 0xc9, 0xd5, 0x03);
        ...
        private static Guid ActivationDispatchSessionTaskGuid = new Guid(unchecked((int)0xcc62b5a3), unchecked((short)0x2fe1), unchecked((short)0x4546), 0xae, 0x18, 0x2e, 0xa4, 0x2a, 0xaf, 0x49, 0x78);
        private static Guid ActivationDuplicateSocketTaskGuid = new Guid(unchecked((int)0xa8cea9f0), unchecked((short)0x416c), unchecked((short)0x4631), 0xaf, 0xbb, 0xbd, 0xd7, 0x85, 0x95, 0x63, 0x24);
        private static Guid ActivationListenerOpenTaskGuid = new Guid(unchecked((int)0x2f44781b), unchecked((short)0x94da), unchecked((short)0x4a82), 0x9b, 0xfd, 0x2d, 0x86, 0xc6, 0x7b, 0x6d, 0x59);
        private static Guid ActivationPipeListenerListeningTaskGuid = new Guid(unchecked((int)0x290d600c), unchecked((short)0x9ac4), unchecked((short)0x4e3f), 0x80, 0x8f, 0x5a, 0xe8, 0xc0, 0x5b, 0xa9, 0x9b);
        private static Guid ActivationRoutingTableLookupTaskGuid = new Guid(unchecked((int)0xa3fe4600), unchecked((short)0x2cbb), unchecked((short)0x4ac2), 0x8f, 0x97, 0x1f, 0x49, 0xf5, 0x55, 0xe4, 0x0d);
        private static Guid ActivationServiceStartTaskGuid = new Guid(unchecked((int)0x258510de), unchecked((short)0xeff7), unchecked((short)0x440b), 0x87, 0xe0, 0xfe, 0xf9, 0xbf, 0x74, 0x02, 0x64);
        private static Guid ActivationTcpListenerListeningTaskGuid = new Guid(unchecked((int)0x7050cd38), unchecked((short)0xffce), unchecked((short)0x4626), 0xa0, 0x4b, 0xe3, 0x38, 0xe1, 0xa5, 0xab, 0xbe);
        private static Guid AddServiceEndpointTaskGuid = new Guid(unchecked((int)0xf102a07a), unchecked((short)0x2a6a), unchecked((short)0x4e97), 0x98, 0xcb, 0x3b, 0xb3, 0xa7, 0x16, 0x0d, 0xb6);
        private static Guid BufferOutOfOrderTaskGuid = new Guid(unchecked((int)0xb47455d1), unchecked((short)0x7962), unchecked((short)0x45da), 0x98, 0x05, 0xdb, 0x7c, 0xc7, 0x93, 0x03, 0x83);
        private static Guid BufferPoolingTaskGuid = new Guid(unchecked((int)0x6f83b987), unchecked((short)0x9660), unchecked((short)0x4211), 0xaf, 0x87, 0x22, 0x99, 0x40, 0x65, 0xd0, 0x3b);
        private static Guid CacheRootMetadataTaskGuid = new Guid(unchecked((int)0xa2c991a1), unchecked((short)0xa330), unchecked((short)0x4f57), 0xac, 0x54, 0x41, 0xf0, 0x99, 0x7c, 0xe7, 0x2e);
        private static Guid ChannelFactoryCachingTaskGuid = new Guid(unchecked((int)0x643d11c2), unchecked((short)0x6eee), unchecked((short)0x4388), 0x96, 0x5e, 0x8b, 0xea, 0xc2, 0xb6, 0xc7, 0x05);
        private static Guid ChannelFactoryCreateTaskGuid = new Guid(unchecked((int)0x8b16dba4), unchecked((short)0x17cb), unchecked((short)0x451f), 0x9d, 0xce, 0x2b, 0x6a, 0x0a, 0x61, 0xd2, 0x30);
        private static Guid ChannelReceiveTaskGuid = new Guid(unchecked((int)0xbdaeec18), unchecked((short)0x49e2), unchecked((short)0x46da), 0xbd, 0x4c, 0xb3, 0x2f, 0x3e, 0x95, 0x5c, 0xfb);
        private static Guid ClientRuntimeTaskGuid = new Guid(unchecked((int)0x2a726cd5), unchecked((short)0x610e), unchecked((short)0x4a23), 0xb4, 0x11, 0x61, 0xf1, 0xd8, 0xab, 0x24, 0x4d);
        private static Guid ClientSendPreambleTaskGuid = new Guid(unchecked((int)0x00830c8d), unchecked((short)0x78eb), unchecked((short)0x4ea3), 0xbc, 0xae, 0xcf, 0x5f, 0xe6, 0x0f, 0xfd, 0x71);
        private static Guid CompensationStateTaskGuid = new Guid(unchecked((int)0x0da1bff2), unchecked((short)0x411e), unchecked((short)0x430f), 0x8a, 0x5d, 0xc9, 0x56, 0x54, 0x3c, 0x5c, 0x97);
        private static Guid CompleteActivityTaskGuid = new Guid(unchecked((int)0xf2ff22dd), unchecked((short)0x397c), unchecked((short)0x467b), 0x98, 0x12, 0x0a, 0x79, 0xe8, 0xc5, 0xa1, 0x2b);
        private static Guid CompleteWorkItemTaskGuid = new Guid(unchecked((int)0x63680005), unchecked((short)0xee91), unchecked((short)0x4154), 0xae, 0x7a, 0x24, 0x09, 0x42, 0x51, 0x0b, 0x98);
        private static Guid ConnectTaskGuid = new Guid(unchecked((int)0x7386e51a), unchecked((short)0x8418), unchecked((short)0x4599), 0xb8, 0x2f, 0xd1, 0xd0, 0x89, 0x25, 0xc8, 0xd6);
        private static Guid ConnectionAbortTaskGuid = new Guid(unchecked((int)0xd28a7513), unchecked((short)0x7db8), unchecked((short)0x4175), 0x9c, 0x38, 0x3a, 0xe9, 0x8e, 0x63, 0x3f, 0x75);
        private static Guid ConnectionAcceptTaskGuid = new Guid(unchecked((int)0x8289b69b), unchecked((short)0x1b48), unchecked((short)0x4160), 0xae, 0x03, 0x50, 0xa6, 0xea, 0x89, 0x3e, 0x61);
        private static Guid ConnectionPoolingTaskGuid = new Guid(unchecked((int)0xbc25d06d), unchecked((short)0xa60a), unchecked((short)0x4769), 0xa3, 0xf2, 0x38, 0x58, 0xb0, 0xe7, 0xc5, 0xdb);
        private static Guid CorrelationTaskGuid = new Guid(unchecked((int)0xa945f7d1), unchecked((short)0x4dba), unchecked((short)0x4537), 0xb8, 0xde, 0xa2, 0xdb, 0x62, 0x1e, 0x2a, 0xde);
        private static Guid CreateBookmarkTaskGuid = new Guid(unchecked((int)0xd156f187), unchecked((short)0xf5c0), unchecked((short)0x4213), 0xb8, 0x59, 0x87, 0xc7, 0x61, 0x61, 0x67, 0x02);
        private static Guid CreateHttpMessageHandlerTaskGuid = new Guid(unchecked((int)0x4c4e08dd), unchecked((short)0x6602), unchecked((short)0x4cbe), 0xb3, 0x38, 0xd4, 0x2f, 0xd1, 0x9a, 0xc9, 0x0b);
        private static Guid CreateWorkflowServiceHostTaskGuid = new Guid(unchecked((int)0xdc5e2af3), unchecked((short)0x2c21), unchecked((short)0x40d9), 0x82, 0x16, 0x68, 0x32, 0xb1, 0x1d, 0x57, 0x96);
        private static Guid CustomTrackingRecordTaskGuid = new Guid(unchecked((int)0x01132c8e), unchecked((short)0xcb5f), unchecked((short)0x47c8), 0x98, 0xc3, 0x67, 0x47, 0x34, 0x40, 0xcd, 0xad);
        private static Guid DataContractResolverTaskGuid = new Guid(unchecked((int)0x5809dff9), unchecked((short)0xc1eb), unchecked((short)0x469d), 0x9a, 0x88, 0xd1, 0xe7, 0x08, 0x22, 0x5c, 0x03);
        private static Guid DiscoveryClientTaskGuid = new Guid(unchecked((int)0x3419e18e), unchecked((short)0xab9c), unchecked((short)0x495f), 0x88, 0x53, 0x4f, 0xd2, 0x53, 0xfe, 0xe7, 0x42);
        private static Guid DiscoveryClientChannelTaskGuid = new Guid(unchecked((int)0x1733b7bf), unchecked((short)0xbeb5), unchecked((short)0x4f77), 0x9c, 0xa4, 0xfb, 0x4e, 0x47, 0xb8, 0xba, 0x92);
        private static Guid DiscoveryMessageTaskGuid = new Guid(unchecked((int)0x6718f681), unchecked((short)0xceb8), unchecked((short)0x418b), 0xaa, 0x29, 0x2d, 0x4b, 0x17, 0x62, 0xfc, 0xdc);
        private static Guid DiscoverySynchronizationContextTaskGuid = new Guid(unchecked((int)0x6dae34cb), unchecked((short)0xa41e), unchecked((short)0x4f83), 0x92, 0x15, 0x36, 0xa6, 0xd9, 0x9b, 0x92, 0x0f);
        private static Guid DispatchMessageTaskGuid = new Guid(unchecked((int)0xcfa3eff0), unchecked((short)0xbf4d), unchecked((short)0x48ba), 0x94, 0x8e, 0x7d, 0x74, 0x7d, 0x4c, 0x3c, 0x29);
        private static Guid EndpointDiscoverabilityTaskGuid = new Guid(unchecked((int)0x3a550486), unchecked((short)0x6e72), unchecked((short)0x409a), 0xaf, 0x80, 0x2b, 0xdd, 0x33, 0xd9, 0x5d, 0xe7);
        private static Guid ExecuteActivityTaskGuid = new Guid(unchecked((int)0xe36d0c20), unchecked((short)0x32cb), unchecked((short)0x4568), 0x98, 0x97, 0x66, 0x3f, 0x38, 0x2a, 0x02, 0xe5);
        private static Guid ExecuteFlowchartTaskGuid = new Guid(unchecked((int)0x4a46e34a), unchecked((short)0x6765), unchecked((short)0x4bdd), 0xb8, 0x1d, 0x7c, 0x77, 0x38, 0xad, 0x6c, 0x3f);
        private static Guid ExecuteWorkItemTaskGuid = new Guid(unchecked((int)0x6d072edb), unchecked((short)0x429e), unchecked((short)0x4046), 0x93, 0x97, 0xaf, 0xf0, 0x05, 0x75, 0x2e, 0xb2);
        private static Guid ExpressionResultTaskGuid = new Guid(unchecked((int)0x046c6554), unchecked((short)0x41aa), unchecked((short)0x4e98), 0xba, 0x6c, 0x2e, 0xd4, 0x57, 0xc4, 0x2e, 0xb9);
        private static Guid FormatterDeserializeReplyTaskGuid = new Guid(unchecked((int)0x1383449f), unchecked((short)0x3231), unchecked((short)0x4a82), 0xb0, 0x8f, 0xa6, 0x7b, 0x5d, 0xf7, 0x1c, 0x6f);
        private static Guid FormatterDeserializeRequestTaskGuid = new Guid(unchecked((int)0xa6034273), unchecked((short)0xe068), unchecked((short)0x4663), 0xa5, 0xbb, 0xa3, 0xbb, 0xc1, 0x3b, 0x19, 0x53);
        private static Guid FormatterSerializeReplyTaskGuid = new Guid(unchecked((int)0xcbf0fa02), unchecked((short)0x6964), unchecked((short)0x4298), 0x9b, 0xf7, 0x2f, 0x03, 0x79, 0xf8, 0x36, 0x08);
        private static Guid FormatterSerializeRequestTaskGuid = new Guid(unchecked((int)0x150fd34c), unchecked((short)0x30d9), unchecked((short)0x41c0), 0xbc, 0xd0, 0x86, 0x78, 0x4a, 0x36, 0xbe, 0x3b);
        private static Guid GenerateDeserializerTaskGuid = new Guid(unchecked((int)0x0a195d68), unchecked((short)0xee49), unchecked((short)0x4a4b), 0xb3, 0x11, 0x36, 0x71, 0x7a, 0xd8, 0xe8, 0x42);
        private static Guid GenerateSerializerTaskGuid = new Guid(unchecked((int)0x2eac2877), unchecked((short)0xe183), unchecked((short)0x4280), 0x84, 0x7e, 0xdb, 0xb4, 0x4b, 0xaf, 0x64, 0x29);
        private static Guid GenerateXmlSerializableTaskGuid = new Guid(unchecked((int)0x2bd9d243), unchecked((short)0x9e23), unchecked((short)0x4a78), 0x9a, 0xda, 0x60, 0x0c, 0xc1, 0x28, 0xf7, 0xff);
        private static Guid HostedTransportConfigurationManagerConfigInitTaskGuid = new Guid(unchecked((int)0x209e9d89), unchecked((short)0x3301), unchecked((short)0x4132), 0xb1, 0x2e, 0xcb, 0x03, 0xb4, 0xc9, 0x08, 0xd1);
        private static Guid ImportKnownTypeTaskGuid = new Guid(unchecked((int)0x751739d0), unchecked((short)0x0aff), unchecked((short)0x4f56), 0xb8, 0x78, 0xc2, 0x70, 0xc5, 0x8a, 0x17, 0xa1);
        private static Guid InferDescriptionTaskGuid = new Guid(unchecked((int)0x11efeeee), unchecked((short)0x6ca2), unchecked((short)0x484c), 0x9f, 0x52, 0x39, 0x96, 0xd4, 0x0e, 0x39, 0x73);
        private static Guid InitializeBookmarkScopeTaskGuid = new Guid(unchecked((int)0x19b94d63), unchecked((short)0x4a80), unchecked((short)0x4eed), 0xaf, 0xc7, 0x48, 0x13, 0xf2, 0xc3, 0xd3, 0x17);
        private static Guid InternalCacheMetadataTaskGuid = new Guid(unchecked((int)0xb7c65e88), unchecked((short)0x50b2), unchecked((short)0x49c8), 0x9c, 0x5f, 0x56, 0x79, 0xeb, 0x06, 0x63, 0x5a);
        private static Guid InvokeMethodTaskGuid = new Guid(unchecked((int)0x281c1dc8), unchecked((short)0xac41), unchecked((short)0x4170), 0xa7, 0xef, 0x13, 0xd2, 0x16, 0xff, 0x58, 0x73);
        private static Guid ListenerOpenTaskGuid = new Guid(unchecked((int)0xdb4cadc2), unchecked((short)0x970c), unchecked((short)0x46b3), 0x99, 0x95, 0x74, 0xf3, 0x99, 0xe5, 0x7d, 0x25);
        private static Guid LockWorkflowInstanceTaskGuid = new Guid(unchecked((int)0xc9dec4a9), unchecked((short)0x2a27), unchecked((short)0x48ae), 0x9b, 0x76, 0x07, 0x3a, 0x60, 0xaa, 0x1b, 0xdf);
        private static Guid MessageChannelCacheTaskGuid = new Guid(unchecked((int)0x09bf4c8a), unchecked((short)0x579b), unchecked((short)0x44ea), 0x8c, 0xd9, 0x24, 0x90, 0xac, 0x2e, 0x64, 0x0f);
        private static Guid MessageDecodingTaskGuid = new Guid(unchecked((int)0x3c7bb03f), unchecked((short)0xcb27), unchecked((short)0x4ac7), 0x88, 0xb3, 0x74, 0x99, 0x6c, 0x38, 0xd0, 0x0f);
        private static Guid MessageEncodingTaskGuid = new Guid(unchecked((int)0x7d9dc4bc), unchecked((short)0xcf40), unchecked((short)0x494d), 0x9e, 0x9d, 0xab, 0x00, 0xe9, 0xd9, 0x56, 0x28);
        private static Guid MessageQueueRegisterTaskGuid = new Guid(unchecked((int)0x18c94a0d), unchecked((short)0xc90c), unchecked((short)0x4045), 0xad, 0x31, 0x07, 0xbb, 0x22, 0x2e, 0x6d, 0xbf);
        private static Guid MsmqQuotasTaskGuid = new Guid(unchecked((int)0x01b57294), unchecked((short)0x49fc), unchecked((short)0x4a9d), 0xb4, 0x6d, 0x42, 0x58, 0x9e, 0x86, 0x32, 0x8d);
        private static Guid NoPersistBlockTaskGuid = new Guid(unchecked((int)0x42a1f6b2), unchecked((short)0xf9c5), unchecked((short)0x4dc4), 0xa7, 0xda, 0x18, 0x92, 0xa8, 0x30, 0x46, 0xab);
        private static Guid QuotasTaskGuid = new Guid(unchecked((int)0x3b3023ac), unchecked((short)0xe7bf), unchecked((short)0x4d11), 0x89, 0x6b, 0x78, 0x10, 0xba, 0x5b, 0x43, 0xf5);
        private static Guid ReliableSessionTaskGuid = new Guid(unchecked((int)0xf105d9e4), unchecked((short)0x3bee), unchecked((short)0x44f3), 0x9e, 0x34, 0x17, 0x6c, 0x4c, 0x36, 0x96, 0x6b);
        private static Guid RoutingServiceTaskGuid = new Guid(unchecked((int)0x29e2a04c), unchecked((short)0xaaed), unchecked((short)0x4439), 0xa3, 0x4d, 0x88, 0x40, 0x50, 0x31, 0x7c, 0x37);
        private static Guid RoutingServiceClientTaskGuid = new Guid(unchecked((int)0x854a57e9), unchecked((short)0x7fc3), unchecked((short)0x49be), 0xbf, 0xb1, 0xa4, 0xdf, 0xe1, 0x31, 0x9d, 0x6e);
        private static Guid RoutingServiceFilterTableMatchTaskGuid = new Guid(unchecked((int)0x8d9dab05), unchecked((short)0x283c), unchecked((short)0x4e06), 0x82, 0x0d, 0x1a, 0x86, 0x51, 0x2a, 0x6f, 0xae);
        private static Guid RoutingServiceMessageTaskGuid = new Guid(unchecked((int)0x7604f4c2), unchecked((short)0xda79), unchecked((short)0x4b5c), 0x89, 0x27, 0x89, 0x00, 0x06, 0xa4, 0x3a, 0x3a);
        private static Guid RoutingServiceReceiveContextTaskGuid = new Guid(unchecked((int)0xd051f201), unchecked((short)0xc391), unchecked((short)0x438c), 0xba, 0x86, 0xc4, 0xb3, 0x6a, 0xd4, 0x33, 0x54);
        private static Guid RoutingServiceTransactionTaskGuid = new Guid(unchecked((int)0x39b697ed), unchecked((short)0x79b9), unchecked((short)0x4172), 0xa6, 0x2f, 0xc1, 0x9e, 0x1d, 0x80, 0x7e, 0x32);
        private static Guid RuntimeTransactionTaskGuid = new Guid(unchecked((int)0xe71036aa), unchecked((short)0x4d1e), unchecked((short)0x4acb), 0x8f, 0x5b, 0xd1, 0xab, 0x14, 0x8d, 0xdc, 0x5e);
        private static Guid ScheduleActivityTaskGuid = new Guid(unchecked((int)0x75bfa87e), unchecked((short)0xb64f), unchecked((short)0x4e34), 0xb6, 0xc9, 0xbf, 0x31, 0x5b, 0xab, 0x52, 0x68);
        private static Guid ScheduleWorkItemTaskGuid = new Guid(unchecked((int)0xe55a99e9), unchecked((short)0xadf3), unchecked((short)0x4da2), 0xb8, 0x12, 0x37, 0x6c, 0x68, 0x2a, 0xd9, 0x91);
        private static Guid SecureMessageTaskGuid = new Guid(unchecked((int)0x4a44e657), unchecked((short)0xbb88), unchecked((short)0x40e6), 0xb4, 0xb6, 0x7c, 0x4b, 0xad, 0xe8, 0x64, 0x5c);
        private static Guid SecurityImpersonationTaskGuid = new Guid(unchecked((int)0x215c2b1c), unchecked((short)0xbcc4), unchecked((short)0x406b), 0x92, 0x8f, 0x53, 0xc5, 0xaf, 0x9a, 0xb8, 0xce);
        private static Guid SecurityNegotiationTaskGuid = new Guid(unchecked((int)0x906923a1), unchecked((short)0x1501), unchecked((short)0x456b), 0xad, 0x24, 0xdc, 0x6e, 0x6e, 0x7a, 0x7e, 0x0e);
        private static Guid SecurityVerificationTaskGuid = new Guid(unchecked((int)0xa18a4968), unchecked((short)0xa0fe), unchecked((short)0x4218), 0xa2, 0xc6, 0x41, 0xbc, 0x98, 0x04, 0xae, 0x40);
        private static Guid ServiceActivationTaskGuid = new Guid(unchecked((int)0x495cdd67), unchecked((short)0x1051), unchecked((short)0x4a73), 0x86, 0x71, 0xf5, 0x5c, 0xd4, 0xf8, 0x26, 0x2a);
        private static Guid ServiceChannelCallTaskGuid = new Guid(unchecked((int)0xe0bc1bbf), unchecked((short)0xdc44), unchecked((short)0x4bfe), 0x82, 0x48, 0xc1, 0x35, 0x47, 0x47, 0x1d, 0xe5);
        private static Guid ServiceChannelOpenTaskGuid = new Guid(unchecked((int)0x3a4d4500), unchecked((short)0xa5ff), unchecked((short)0x48e8), 0x98, 0xf3, 0x03, 0x1e, 0x37, 0xc7, 0x5c, 0x46);
        private static Guid ServiceHostActivationTaskGuid = new Guid(unchecked((int)0x889b37e9), unchecked((short)0x86e8), unchecked((short)0x4394), 0xb9, 0xcf, 0x51, 0xa9, 0xf8, 0x61, 0x51, 0xf3);
        private static Guid ServiceHostCompilationTaskGuid = new Guid(unchecked((int)0xb89a8822), unchecked((short)0xf97f), unchecked((short)0x4dc6), 0xa8, 0x5f, 0x82, 0xa1, 0x85, 0x58, 0xe8, 0xfc);
        private static Guid ServiceHostCreateTaskGuid = new Guid(unchecked((int)0x6b129f40), unchecked((short)0xfc49), unchecked((short)0x4032), 0x8e, 0xc4, 0x0b, 0x13, 0x96, 0xa4, 0x7d, 0x5d);
        private static Guid ServiceHostFactoryCreationTaskGuid = new Guid(unchecked((int)0x9c411076), unchecked((short)0x9eb0), unchecked((short)0x4579), 0x87, 0x41, 0xf8, 0x03, 0x7e, 0x91, 0x40, 0xdc);
        private static Guid ServiceHostFaultTaskGuid = new Guid(unchecked((int)0xa3276f7a), unchecked((short)0xbf2b), unchecked((short)0x4e74), 0xb4, 0xd5, 0x23, 0x29, 0xb0, 0xb1, 0x96, 0x20);
        private static Guid ServiceHostOpenTaskGuid = new Guid(unchecked((int)0x0a0d5fc5), unchecked((short)0x939d), unchecked((short)0x4f85), 0x9c, 0x73, 0x6b, 0x10, 0xbe, 0x96, 0xfa, 0xea);
        private static Guid ServiceInstanceTaskGuid = new Guid(unchecked((int)0xb0cd6c86), unchecked((short)0x90b8), unchecked((short)0x4382), 0xb8, 0xe0, 0x40, 0xf7, 0x7a, 0x70, 0x58, 0x4a);
        private static Guid ServiceShutdownTaskGuid = new Guid(unchecked((int)0xaa2e18aa), unchecked((short)0x3618), unchecked((short)0x4be9), 0xb9, 0x38, 0x5a, 0x04, 0xff, 0xc0, 0xd2, 0x32);
        private static Guid SessionStartTaskGuid = new Guid(unchecked((int)0x5fab4482), unchecked((short)0x260c), unchecked((short)0x4280), 0xa6, 0x70, 0x72, 0xcb, 0x40, 0xa6, 0xd3, 0x8c);
        private static Guid SessionUpgradeTaskGuid = new Guid(unchecked((int)0x29f551a4), unchecked((short)0x5a53), unchecked((short)0x4ce2), 0xb7, 0x08, 0x38, 0x98, 0x3b, 0x5f, 0x68, 0xcc);
        private static Guid SignpostTaskGuid = new Guid(unchecked((int)0x467f2eed), unchecked((short)0x797f), unchecked((short)0x4a5b), 0xaa, 0x77, 0xf6, 0x0e, 0x81, 0x74, 0xd2, 0x87);
        private static Guid SqlCommandExecuteTaskGuid = new Guid(unchecked((int)0x837f6564), unchecked((short)0x75a0), unchecked((short)0x4ca1), 0x80, 0x87, 0x23, 0x06, 0x99, 0x35, 0xef, 0xa4);
        private static Guid StartWorkItemTaskGuid = new Guid(unchecked((int)0x8931a237), unchecked((short)0xd6c2), unchecked((short)0x42c7), 0x94, 0x38, 0x83, 0xee, 0x5d, 0x3a, 0x24, 0xc1);
        private static Guid SurrogateDeserializeTaskGuid = new Guid(unchecked((int)0xfd67d29d), unchecked((short)0x3b67), unchecked((short)0x4138), 0x85, 0x3f, 0x02, 0xfe, 0xbd, 0xb1, 0xbb, 0x3c);
        private static Guid SurrogateSerializeTaskGuid = new Guid(unchecked((int)0x48379681), unchecked((short)0x20f4), unchecked((short)0x4ba2), 0x92, 0x59, 0xf7, 0x97, 0x94, 0x9b, 0x31, 0x72);
        private static Guid ThreadSchedulingTaskGuid = new Guid(unchecked((int)0x8ab777e0), unchecked((short)0x9d97), unchecked((short)0x498f), 0xbe, 0xc6, 0xee, 0xd9, 0xf9, 0x73, 0x2e, 0x1a);
        private static Guid ThrottlesTaskGuid = new Guid(unchecked((int)0xf71d9f5c), unchecked((short)0x8697), unchecked((short)0x457f), 0xac, 0xaa, 0x78, 0x48, 0xc7, 0xf7, 0x1c, 0x33);
        private static Guid TimeoutTaskGuid = new Guid(unchecked((int)0xcbb66a44), unchecked((short)0x9a0d), unchecked((short)0x498c), 0xba, 0x30, 0xf5, 0x2f, 0x9b, 0x11, 0xd7, 0x34);
        private static Guid TimeoutExceptionTaskGuid = new Guid(unchecked((int)0xa2b6a84c), unchecked((short)0x3e36), unchecked((short)0x4847), 0xb6, 0x3a, 0x04, 0x6b, 0xb4, 0xff, 0xb0, 0xfc);
        private static Guid TrackingProfileTaskGuid = new Guid(unchecked((int)0xb8405407), unchecked((short)0xf1c7), unchecked((short)0x436b), 0x9c, 0xc7, 0xd1, 0x41, 0xca, 0xd8, 0xa9, 0xa1);
        private static Guid TrackingRecordTaskGuid = new Guid(unchecked((int)0xb92f3124), unchecked((short)0x6b3b), unchecked((short)0x41ca), 0x89, 0x70, 0xa0, 0x19, 0x51, 0xfc, 0x87, 0x1a);
        private static Guid TransportReceiveTaskGuid = new Guid(unchecked((int)0x32dc9a79), unchecked((short)0xb143), unchecked((short)0x42c0), 0x84, 0x7e, 0x1a, 0x0d, 0x81, 0x58, 0xfa, 0x82);
        private static Guid TransportSendTaskGuid = new Guid(unchecked((int)0x21222074), unchecked((short)0xfec4), unchecked((short)0x4a37), 0xa5, 0x02, 0x7d, 0x3f, 0xa5, 0xdd, 0x7b, 0xbd);
        private static Guid TryCatchExceptionTaskGuid = new Guid(unchecked((int)0xf1a89c01), unchecked((short)0x0cd8), unchecked((short)0x425e), 0x8b, 0xaa, 0x20, 0x20, 0x99, 0x8b, 0xa2, 0x02);
        private static Guid VBExpressionCompileTaskGuid = new Guid(unchecked((int)0x56082d31), unchecked((short)0x0408), unchecked((short)0x471b), 0xbd, 0x3a, 0xb6, 0x06, 0x0d, 0x54, 0xaa, 0xf6);
        private static Guid WASActivationTaskGuid = new Guid(unchecked((int)0x37cc9fa0), unchecked((short)0x54bc), unchecked((short)0x4e2a), 0xb9, 0xf7, 0x3e, 0x13, 0x81, 0xd0, 0x4f, 0x84);
        private static Guid WebHostRequestTaskGuid = new Guid(unchecked((int)0x2b36e2cf), unchecked((short)0xca86), unchecked((short)0x455e), 0xa5, 0xd0, 0xc3, 0xdc, 0x17, 0x8b, 0x45, 0xa7);
        private static Guid WFApplicationStateChangeTaskGuid = new Guid(unchecked((int)0xe2f60385), unchecked((short)0xfabc), unchecked((short)0x46ba), 0xb6, 0x0a, 0x16, 0x44, 0xa9, 0x6d, 0xda, 0x92);
        private static Guid WFMessageTaskGuid = new Guid(unchecked((int)0xf048298b), unchecked((short)0xe812), unchecked((short)0x42b8), 0xa0, 0xfe, 0x39, 0x9a, 0x94, 0x17, 0xcc, 0x12);
        private static Guid WorkflowActivityTaskGuid = new Guid(unchecked((int)0xd0c1971f), unchecked((short)0xe415), unchecked((short)0x4b16), 0x92, 0x7d, 0x4a, 0x07, 0x10, 0x21, 0x76, 0xff);
        private static Guid WorkflowInstanceRecordTaskGuid = new Guid(unchecked((int)0xba2a6ac8), unchecked((short)0x4687), unchecked((short)0x470a), 0xbe, 0xb8, 0x0f, 0x73, 0xa0, 0x88, 0x0b, 0xff);
        private static Guid WorkflowTrackingTaskGuid = new Guid(unchecked((int)0x4dc544cd), unchecked((short)0xa2dd), unchecked((short)0x47c1), 0x98, 0xf8, 0x2d, 0xbf, 0xd5, 0xb2, 0xdb, 0x84);
        private static Guid XamlServicesLoadTaskGuid = new Guid(unchecked((int)0x757f24b4), unchecked((short)0x6432), unchecked((short)0x4ad2), 0xa7, 0x5c, 0x8a, 0xe2, 0xc3, 0x19, 0x98, 0xf1);
        private static Guid SignatureVerificationTaskGuid = new Guid(unchecked((int)0x022b7eea), unchecked((short)0xcd11), unchecked((short)0x47d6), 0x80, 0xc1, 0xed, 0x30, 0xac, 0x7a, 0x8a, 0x1f);
        private static Guid TokenValidationTaskGuid = new Guid(unchecked((int)0xf3a96f6f), unchecked((short)0x1af7), unchecked((short)0x4229), 0x96, 0x97, 0x68, 0x89, 0xfd, 0x45, 0x8a, 0x97);
        private static Guid GetIssuerNameTaskGuid = new Guid(unchecked((int)0x042e133f), unchecked((short)0xf3bd), unchecked((short)0x4fba), 0xb8, 0xb7, 0x2a, 0x9f, 0x72, 0x71, 0x51, 0xdb);
        private static Guid WrappedKeyDecryptionTaskGuid = new Guid(unchecked((int)0x59725508), unchecked((short)0xd5cc), unchecked((short)0x4c89), 0x8d, 0xa0, 0x9a, 0xd2, 0xb8, 0x85, 0x2b, 0xaa);
        private static Guid EncryptedDataProcessingTaskGuid = new Guid(unchecked((int)0x81db23be), unchecked((short)0x6eda), unchecked((short)0x4c2b), 0xb1, 0x02, 0x6c, 0xd8, 0x81, 0x82, 0x35, 0x92);
        private static Guid FederationMessageProcessingTaskGuid = new Guid(unchecked((int)0xe8353704), unchecked((short)0xaea1), unchecked((short)0x489f), 0xb8, 0x33, 0x10, 0xda, 0xb2, 0x91, 0x3f, 0x40);
        private static Guid FederationMessageCreationTaskGuid = new Guid(unchecked((int)0xb50f0e7d), unchecked((short)0x8cd3), unchecked((short)0x446b), 0xa8, 0x06, 0xda, 0x9b, 0xda, 0x5f, 0xfb, 0xaf);
        private static Guid SessionCookieReadingTaskGuid = new Guid(unchecked((int)0xbca1e46d), unchecked((short)0xd690), unchecked((short)0x4ca4), 0x93, 0x0a, 0x4c, 0x4c, 0x67, 0xcc, 0x79, 0x06);
        private static Guid PrincipalSettingTaskGuid = new Guid(unchecked((int)0x70502091), unchecked((short)0x88e2), unchecked((short)0x47e9), 0x90, 0x66, 0xa7, 0x33, 0xcf, 0x8c, 0x4e, 0xcd);
        #endregion
    }
}
