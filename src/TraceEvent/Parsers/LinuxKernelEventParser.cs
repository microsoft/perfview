...
namespace Microsoft.Diagnostics.Tracing.Parsers.LinuxKernel
{
    ...
    {
        // Code generated by TraceParserGen but not applicable: get ProcessID and ProcessName from context stream instead of event payload
        ...
        protected internal override void Validate()
        {
            // TODO: write new Validate for this TraceEvent
            // Code generated by TraceParserGen but not applicable 
            //Debug.Assert(!(Version == 0 && EventDataLength != SkipUnicodeString(4)));
            //Debug.Assert(!(Version > 0 && EventDataLength < SkipUnicodeString(4)));
        }
        protected internal override Delegate Target
