        ...
        unsafe private void SetupCallbacks(TraceEventDispatcher rawEvents)
        {
            ...
            Action<ModuleLoadUnloadTraceData> onLoaderRundown = delegate (ModuleLoadUnloadTraceData data)
           {
            ...
            kernelParser.PerfInfoSample += delegate (SampledProfileTraceData data)
            {
                ...
                /* This logic does not work because  we can have a Sample that happens in USER mode between the kernel event
                   and its user mode stack.  
 
                G:\repos\perfView-vancem\src\TraceEvent\TraceEvent.Tests\bin\Debug\net46\unzipped\net.4.6.2.x86.etl

Event Name                    	Time MSec	Process Name 	ThreadID	EventTimeStampRelativeMSec	IP0               	InstructionPointer
Windows Kernel/PerfInfo/Sample	1,357.127	svchost (348)	 1,452  	                          	                  	0xfffff80373b45c31
Windows Kernel/StackWalk/Stack	1,357.136	svchost (348)	 1,452  	 1,357.127                	0xfffff80373b45c31	                  

BAD     Kernel/PerfInfo/Sample	1,358.125	svchost (348)	 1,452  	                          	                  	0x7ffdab674634    
Windows Kernel/StackWalk/Stack	1,358.141	svchost (348)	 1,452  	 1,357.127                	0x7ffdab674634    	                
                 */
