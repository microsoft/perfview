...
namespace Microsoft.Diagnostics.Tracing
{
    ...
    {
        public EventPipeEventSource(string fileName) : this(new PinnedStreamReader(fileName, 0x20000, new SerializationConfiguration() { StreamLabelWidth = StreamLabelWidth.EightBytes }), fileName)
        {
        }

        public EventPipeEventSource(Stream stream)
            : this(new PinnedStreamReader(stream, config: new SerializationConfiguration() { StreamLabelWidth = StreamLabelWidth.EightBytes }, alignment: StreamReaderAlignment.OneByte), "stream")
        {
        }
