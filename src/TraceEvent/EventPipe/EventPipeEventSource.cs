...
namespace Microsoft.Diagnostics.Tracing
{
    ...
    {
        public EventPipeEventSource(string fileName) : this(new PinnedStreamReader(fileName, 0x20000, new SerializationConfiguration() { StreamLabelWidth = StreamLabelWidth.EightBytes }), fileName, false)
        {
        }

        public EventPipeEventSource(Stream stream)
            : this(new PinnedStreamReader(stream, alignment: StreamReaderAlignment.OneByte, config: new SerializationConfiguration() { StreamLabelWidth = StreamLabelWidth.EightBytes }), "stream", true)
        {
        }
