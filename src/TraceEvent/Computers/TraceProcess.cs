...
namespace Microsoft.Diagnostics.Tracing.Analysis
{
    ...
    public static class TraceProcessesExtensions
    {
        ...
        public static bool TryGetProcess(this TraceEvent _event, out TraceProcess process)
        {
            process = _event.source.Processes().GetProcess(_event.ProcessID, _event.TimeStampQPC);
            return (process != null);
        }
